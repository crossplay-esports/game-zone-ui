  ...
  return (
    <div style={{ marginTop: "20px" }}>
      <Container>
        ...
        <br></br>
        <Typography variant="h8">SECTION 1 - ONLINE STORE TERMS</Typography>
        <Typography paragraph variany="body1">
        ...
        <Typography variant="h8">SECTION 2 - GENERAL CONDITIONS</Typography>
        ...
        <Typography variant="h8">SECTION 7 - OPTIONAL TOOLS</Typography>
        <Typography paragraph>
        ...
        <Typography variant="h8">SECTION 8 - THIRD-PARTY</Typography>
        <Typography paragraph>
          LINKS Certain content, products and services available via our Service
        ...
        <Typography variant="h8">SECTION 10 - PERSONAL INFORMATION</Typography>
        <Typography paragraph>
        ...
        <Typography variant="h8"> SECTION 12 - PROHIBITED USES</Typography>
        <Typography paragraph>
        ...
        <Typography variant="h8">SECTION 15 - SEVERABILITY</Typography>
        <Typography paragraph>
        ...
        <Typography variant="h8">SECTION 16 - TERMINATION</Typography>
        <Typography paragraph>
        ...
        <Typography variant="h8">SECTION 17 - ENTIRE AGREEMENT</Typography>
        <Typography paragraph>
        ...
        <Typography variant="h8">SECTION 18 - GOVERNING LAW</Typography>
        <Typography paragraph>
          These Terms of Service and any separate agreements whereby we provide
          you Services shall be governed by and construed in accordance with the
          laws of c 135, Haldia, AN, 721607, India.
        </Typography>
        <Typography variant="h8">
          {" "}
        ...
        <Typography variant="h8"> SECTION 20 - CONTACT INFORMATION</Typography>
        <Typography paragraph>
          Questions about the Terms of Service should be sent to us at
          tiyasgerrard@outlook.com.
        </Typography>
      </Container>
    </div>
  );
